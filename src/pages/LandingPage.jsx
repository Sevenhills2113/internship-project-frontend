            ...
            <header className="hero-section">
                <div className="hero-content">
                    ...
                    <p className="hero-subtitle">
                        ...
                        mentor-guided internship programs. Master the tech stack that matters.
                    </p>
                    ...
                    <div className="cta-group">
                        ...
                        <button className="cta-button secondary" onClick={() => window.scrollTo(0, 800)}>
                            Explore Programs
                        </button>
                    </div>
                    ...
                    <div className="trust-badges">
                        ...
                        <div className="logos">
                            <span>MIT</span> • <span>Stanford</span> • <span>IIT</span> • <span>BITS</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="hero-visual">
                    <div className="glass-card main-card">
                        ...
                        <div className="code-content">
                            <span className="keyword">const</span> <span className="variable">internship</span> = &#123; <br />
                            &nbsp;&nbsp;status: <span className="string">"Hired"</span>,<br />
                            &nbsp;&nbsp;skills: [<span className="string">"React"</span>, <span className="string">"Node"</span>],<br />
                            &nbsp;&nbsp;salary: <span className="number">120000</span><br />
                            &#125;;
                        </div>
            ...
            <section className="features-section">
                ...
                <div className="features-grid">
                    <div className="feature-card">
                        ...
                        <p>Follow a clear roadmap designed by industry experts to master complex topics step-by-step.</p>
                    </div>

                    <div className="feature-card">
                        <div className="icon-box">💡</div>
                        <h3>Real Projects</h3>
                        <p>Work on tasks that mimic real-world software development. No more "todo list" tutorials.</p>
                    </div>

                    <div className="feature-card">
                        <div className="icon-box">🤝</div>
                        <h3>Expert Mentorship</h3>
                        <p>Get code reviews and personalized feedback from experienced senior engineers.</p>
                    </div>
                </div>
            </section>
